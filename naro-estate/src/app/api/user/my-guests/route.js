    ...
    try {
        ...
        const user = await User.findById(userId).populate({
            ...
            populate: [
                ...
                {
                    path: 'userId',
                    select: 'firstname lastname' // Only include the 'username' field from the User model
                }
            ]
        });
        ...
        const GuestBookingHistory = user.myGuestBookingHistory;

        // Pagination logic
        const totalBookings = GuestBookingHistory.length;
        ...
        const paginatedBookingHistory = GuestBookingHistory.slice(startIndex, endIndex);
