    ...
    <div className="overflow-x-auto max-w-[90%] mx-auto rounded-lg border border-gray-200 shadow-md mb-4">
      <Table className="min-w-full">
        <TableCaption className="text-md text-gray-700">
          Recent Guests who booked your listings
        </TableCaption>
        <TableHeader className="bg-white">
          <TableRow>
            ...
            <TableHead className="font-bold text-gray-700">Guest Name</TableHead>
        ...
        <TableBody>
          {data.map((item, index) => (
            <TableRow key={item._id} className="hover:bg-gray-50 transition-colors">
              ...
              <TableCell className="text-gray-700">{item.userId.firstname +" "+ item.userId.lastname}</TableCell>
